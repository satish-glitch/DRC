...
import saveQuotePdfToContent from '@salesforce/apex/DRC_NBC_GeneratePdfController.saveSampleOrderPdfToContent';
import { CloseActionScreenEvent } from 'lightning/actions';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class DRC_NBC_GenerateSamplePITemplate extends LightningElement {
    @api recordId;
    errorFound = false;
    errorMessage;
    isLoading = false;
    ...
    savePdf() {
        ...
        saveQuotePdfToContent({
            ...
            .then(() => {
                this.isLoading = false;
                this.showToast('Success', 'Sample Order PDF saved successfully.', 'success');
